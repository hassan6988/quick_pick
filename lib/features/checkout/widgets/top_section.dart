...
class TopSection extends StatelessWidget {
  ...
  final DeliveryChargeResult? deliveryChargeResult;
    ...
    return Container(
      ...
      child: Column(children: [
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              deliveryChargeResult!.storeCharges.isNotEmpty
                  ? ListView.builder(
                      itemCount: deliveryChargeResult!.storeCharges.length,
                      shrinkWrap: true,
                      physics: const NeverScrollableScrollPhysics(),
                      itemBuilder: (context, index) {
                        final storeCharge = deliveryChargeResult!.storeCharges[index];
                        return Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              // Delivery Fee (Right)
                              Text(
                                PriceConverter.convertPrice(storeCharge.deliveryCharge),
        ...
        isGuestLoggedIn && Get.find<SplashController>().configModel!.centralizeLoginSetup!.manualLoginStatus!
            ...
            : const SizedBox(),
        SizedBox(
            height: isGuestLoggedIn && Get.find<SplashController>().configModel!.centralizeLoginSetup!.manualLoginStatus!
                ? Dimensions.paddingSizeSmall
                : 0),
