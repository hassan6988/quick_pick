...
ThemeData dark({Color color = const Color(0xFF00256e)}) => ThemeData(
      ...
      colorScheme:
          ColorScheme.dark(primary: color, secondary: color).copyWith(surface: const Color(0xFF191A26)).copyWith(error: const Color(0xFFdd3135)),
